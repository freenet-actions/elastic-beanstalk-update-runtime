...
class DeleteApplicationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteApplicationMessageFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_query_1.serializeAws_queryDeleteApplicationCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.deserializeAws_queryDeleteApplicationCommand)(output, context);
    }
}
