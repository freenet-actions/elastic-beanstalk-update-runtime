...
class RequestEnvironmentInfoCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, RequestEnvironmentInfoCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.RequestEnvironmentInfoMessageFilterSensitiveLog,
