...
class ListPlatformBranchesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListPlatformBranchesCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListPlatformBranchesRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListPlatformBranchesResultFilterSensitiveLog,
        };
