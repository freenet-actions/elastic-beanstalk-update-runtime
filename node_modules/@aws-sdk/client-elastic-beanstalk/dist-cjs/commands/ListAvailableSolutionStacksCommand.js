...
class ListAvailableSolutionStacksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListAvailableSolutionStacksCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            outputFilterSensitiveLog: models_0_1.ListAvailableSolutionStacksResultMessageFilterSensitiveLog,
        };
